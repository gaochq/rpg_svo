...
/**
 *
 * @param cur_img                   要搜索的图像
 * @param dir                       patch移动的方向
 * @param ref_patch_with_border     加了边界的patch
 * @param ref_patch                 未加边界的patch
 * @param n_iter                    最大迭代次数
 * @param cur_px_estimate           要寻找的匹配点
 * @param h_inv
 * @return
 */
bool align1D(const cv::Mat& cur_img, const Vector2f& dir,                  // direction in which the patch is allowed to move
